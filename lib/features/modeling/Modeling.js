...
Modeling.prototype.getHandlers = function() {
  return {
    ...
    'element.updateAnchor': require('./cmd/UpdateAnchorHandler'),
...
/**
 * Update the anchor on the element with the given delta movement
 * @param  {djs.model.Element} element
 * @param  {Point} delta
 */
Modeling.prototype.updateAnchor = function(element, connection, oldBounds, anchorPosition) {
  var context = {
    element: element,
  ...
  this._commandStack.execute('element.updateAnchor', context);
}
