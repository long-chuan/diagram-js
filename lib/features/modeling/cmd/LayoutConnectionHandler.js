...
LayoutConnectionHandler.prototype.preExecute = function(ctx) {
  // console.log(ctx.connection.waypoints);
  // console.log(JSON.stringify(ctx.connection.waypoints));
}
...
LayoutConnectionHandler.prototype.execute = function(context) {
  ...
  connection.waypoints = context.hints.connection.waypoints || connection.waypoints;
